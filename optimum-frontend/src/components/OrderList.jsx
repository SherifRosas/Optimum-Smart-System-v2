...
const OrderList = ({ orders: propOrders, onStatusUpdate: propOnStatusUpdate }) => {
  // Use React Query if no props provided
  const { data: ordersData, isLoading, error } = useOrders()
  const updateOrderMutation = useUpdateOrderStatus()
  
  const orders = propOrders || ordersData?.results || ordersData || []
  
  const handleStatusUpdate = propOnStatusUpdate || async (id, status) => {
    try {
