...
function CommandCenter({ orders = [], onNavigate }: CommandCenterProps) {
  ...
  const stats = [
    { value: totalOrders, label: 'Total Orders', icon: '📦', color: 'cyan' as const, delay: 0 },
    { value: activeOrders, label: 'Active Now', icon: '⚡', color: 'green' as const, delay: 200 },
    { value: Math.floor(totalRevenue), label: 'Revenue (EGP)', icon: '💰', color: 'orange' as const, delay: 400 },
    { value: totalSuppliers, label: 'Suppliers', icon: '🏭', color: 'magenta' as const, delay: 600 }
  ];
          ...
          <div className="dashboard-grid">
            ...
            <section className="orders-section card">
              <div className="section-header">
                ...
                <button className="section-action" onClick={() => onNavigate && onNavigate('orders')}>View All →</button>
              </div>
