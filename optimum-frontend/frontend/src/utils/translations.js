...
export const translations = {
  en: {
    ...
    viewAll: "View All",
    newOrderReceived: "New order received from",
    supplierConfirmed: "Supplier confirmed shipment",
    orderMarkedDelivered: "Order marked as delivered",
    aiAssignedSupplier: "AI assigned optimal supplier for",
    ...
    realTimeOrderManagement: "Real-time order management & AI analytics",
    export: "Export",
    newOrder: "New Order",
    dashboard: "Dashboard",
    orders: "Orders",
  ...
  ar: {
    ...
    viewAll: "عرض الكل",
    newOrderReceived: "تم استلام طلب جديد من",
    supplierConfirmed: "المورد أكد الشحنة",
    orderMarkedDelivered: "تم تسليم الطلب",
    aiAssignedSupplier: "الذكاء الاصطناعي عيّن المورد الأمثل لـ",
    paymentReceived: "تم استلام الدفع لـ",
    justNow: "الآن",
    minAgo: "منذ دقيقة",
    ...
    realTimeOrderManagement: "إدارة الطلبات في الوقت الفعلي وتحليلات الذكاء الاصطناعي",
    export: "تصدير",
    newOrder: "طلب جديد",
    dashboard: "لوحة التحكم",
    orders: "الطلبات",
